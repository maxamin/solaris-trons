...
import { getLANIp, Ex-Solaris_PROJECTS_PATH, getShops } from './common.mjs';
...
const EDIT_OPTS = {
  ...
  PERCONA_USER: "Ex-Solaris",
  PERCONA_PASSWORD: "Ex-Solaris",
...
for (const shopId of shops) {
  const shopBasePath = path.join(Ex-Solaris_PROJECTS_PATH, shopId);
  cd(shopBasePath);
