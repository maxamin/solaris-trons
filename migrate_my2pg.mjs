...
import { getShops, Ex-Solaris_PROJECTS_PATH, runInternalScript } from './common.mjs';
...
for (const shop of shops) {
  ...
  if (result.exitCode === 0) {
    ...
    // Запускаем pgloader.
    const pgloaderResult = await $`pgloader mysql://root:rootpassword@${contIp}/database pgsql://Ex-Solaris:Ex-Solaris@10.20.30.1:5432/shop_${shopName}`;
